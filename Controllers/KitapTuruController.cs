    ...
    public class KitapTuruController : Controller
    {
        ...
        public IActionResult Ekle(KitapTuru kitapTuru)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index","KitapTuru"); //burada geri dönüş olarak indexe geri gidiyoruz yani kayıt ettikten sonra listeleme ekranına geri dönüş yapıyoruz
            }
            return View();
